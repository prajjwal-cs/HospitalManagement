...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleUsernameNotFountException(UsernameNotFoundException usernameNotFoundException) {
        ApiError apiError = new ApiError("username not found with username: " +
                usernameNotFoundException.getLocalizedMessage(), HttpStatus.NOT_FOUND);
